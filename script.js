...
function calcStuff1(max1, max2, max3, max4, weight1, weight2, weight3, weight4, score1, score2, score3, score4) {
  ...
  switch(val) {
    case 1:
      ...
      max1 = 1;
      return roundtondigits((weight2*(score2/max2) + weight3*(score3/max3) + weight4 * (score4/max4)) * 100, 2);
    case 2:
      ...
      max2 = 1;
      return roundtondigits((weight1*(score1/max1) + weight3*(score3/max3) + weight4 * (score4/max4)) * 100, 2);
    case 3:
      ...
      max3 = 1;
      return roundtondigits((weight1*(score1/max1) + weight2*(score2/max2) + weight4 * (score4/max4)) * 100, 2);
    case 4:
      ...
      max4 = 1;
      return roundtondigits((weight1*(score1/max1) + weight2*(score2/max2) + weight3*(score3/max3)) * 100, 2);
